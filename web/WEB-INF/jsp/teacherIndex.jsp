...
<header class="header">
    <h1>简易教务系统</h1>
    <div class="headerR">
        <p><span style="color: #fff21b"> ${userSession.tName }</span> , 欢迎你！</p>
...
<section class="functionList ">
    <div class="left">
        <h2>功能列表</h2>
        <ul class="list">
            <li ><a target="right" href="${pageContext.request.contextPath }/jsp/course.do?method=TgetCourse">课程管理</a></li>
            <li><a target="right" href="${pageContext.request.contextPath }/jsp/teacher.do">个人信息</a></li>
